	...
	<div id="gbox-grd">
		...
		<div id="newsletter">
			...
			<form name="myform">
				<table>
					<tr>
						<td><font style="color: navy;">Branch:</font></td>
					...
					<tr>
						<td><font style="color: navy;">Find Manager:-</font></td>
						<td><input type="text" align="right" name="findName"
							onkeyup="sendInfo()"></input></td>
					</tr>
				</table>
				...
				<a href="create.jsp"><font style="color: navy;"><B>Create
							New Manager</B></font></a><BR /> <a href="install.jsp"><font
					style="color: navy;"><B>Install New Truck</B></font></a> <br /> <a
					href="findtruck.jsp"><font style="color: navy;"><B>Search
							Truck</B></font></a>
			</form>
